...
public class DistributionDBAPI extends AbstractDBAPI<Distribution> {
	...
	@Override
	public void hardUpdate(String instanceId, Distribution eposDataModelObject, EntityManager em) {
	...
	private void generateEntity(EDMDistribution edmObject, Distribution eposDataModelObject, EntityManager em, String instanceId, boolean merged) {
